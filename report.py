...
class ReportClass:
    def __init__(self, root):
        ...
        #===title====
        title=Label(self.root,text="View Student Result",font=("Times New Roman",15,"bold"),bg="orange",fg="#262626").place(x=10,y=15,width=1180,height=50)

        #======search======
        self.var_search=StringVar()
        self.var_id=""

        lbl_search=Label(self.root,text="Search By Roll No",font=("Times New Roman",20,"bold"),bg="white").place(x=280,y=100)
        txt_search=Entry(self.root,textvariable=self.var_search,font=("Times New Roman",20),bg="lightyellow").place(x=530,y=100,width=150)
        btn_search=Button(self.root,text="search",font=("goudy old style",15),bg="#0B5377",fg="white",cursor="hand2",command=self.search).place(x=690,y=100,width=100,height=35)
        btn_clear=Button(self.root,text="clear",font=("goudy old style",15),bg="gray",fg="white",cursor="hand2",command=self.clear).place(x=810,y=100,width=100,height=35)
        ...
        lbl_marks=Label(self.root, text="Marks Obtaines",font=("Times New Roman", 15,"bold"),bg="white",bd=2,relief=GROOVE).place( x=600,y=230,width=150,height=50)
        ...
        lbl_per=Label(self.root,text="Percentage",font=("Times New Roman",15,"bold"),bg="white",bd=2,relief=GROOVE).place(x=900,y=230,width=150,height=50)
